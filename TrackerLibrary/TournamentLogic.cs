namespace TrackerLibrary
{
    ...
    public static class TournamentLogic
    {
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            subject = string.Format("In {0}, {1} has won!", model.TournamentName, winners.TeamName);
            ...
            if (winnerPrize > 0)
            {
                body.AppendLine(string.Format("<p>{0} will receive ${1}</p>", winners.TeamName, winnerPrize));
            }

            if (runnerUpPrize > 0)
            {
                body.AppendLine(string.Format("<p>{0} will receive ${1}</p>", runnerUp.TeamName, runnerUpPrize));
            }
        ...
        private static void AlertPersonToNewRound(PersonModel p, string teamName, MatchupEntryModel competitor)
        {
            ...
            if (competitor != null)
            {
                subject = string.Format("You have a new matchup with {0}", competitor.TeamCompeting.TeamName);
